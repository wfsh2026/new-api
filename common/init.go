...
func initConstantEnv() {
	...
	// RelayConcurrencyLimit bounds in-flight relay requests. Zero keeps the historical unlimited behavior.
	constant.RelayConcurrencyLimit = GetEnvOrDefault("RELAY_CONCURRENCY_LIMIT", 0)
